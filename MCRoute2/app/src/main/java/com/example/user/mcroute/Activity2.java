...
public class Activity2 extends AppCompatActivity {
    ...
    final static int lineWidth = 3; //for draw route
    final static String lineColor = "#ff38afea"; //color of the route
    final static String polygonColor = "#7fff0000"; //color of the polygon
                        ...
                        public void onMapReady(MapboxMap mapboxMap) {
                            ...
                            for (int i = 0; i < allPoints.size() - 1; i++) {
                                ...
                                if(Math.abs(temp.getLatitude() - actualPoint.getLatitude())
                                    ...
                                    Toast.makeText(Activity2.this, "juhu", Toast.LENGTH_SHORT).show();
